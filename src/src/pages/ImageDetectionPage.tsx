      ...
      <div className="max-w-4xl mx-auto py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Upload an image to analyze it for synthetic manipulation, AI
            generation artifacts, and digital alterations.
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="flex justify-center">
              ...
              className={`px-8 py-4 rounded-xl font-semibold flex items-center justify-center gap-2 transition-all w-full md:w-auto min-w-[200px]
                  ${file && !isAnalyzing ? 'bg-gradient-to-r from-cyan-500 to-blue-600 text-white shadow-[0_0_20px_rgba(34,211,238,0.3)] hover:shadow-[0_0_30px_rgba(34,211,238,0.5)]' : 'bg-slate-800 text-slate-500 cursor-not-allowed border border-white/5'}
                `}>
